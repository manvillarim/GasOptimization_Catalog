...
contract RewardsController is RewardsDistributor, VersionedInitializable, IRewardsController {
  ...
  function configureAssets(
    ...
    for (uint256 i; i < config.length; i++) {
      ...
      config[i].totalSupply = IScaledBalanceToken(config[i].asset).scaledTotalSupply();uint256 certora_local15 = config[i].totalSupply;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,certora_local15)}
  ...
  function claimAllRewards(
    ...
    require(to != address(0), 'INVALID_TO_ADDRESS');
    (rewardsList, claimedAmounts) = _claimAllRewards(assets, msg.sender, msg.sender, to);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020008,0)}
  }
    ...
    returns (address[] memory rewardsList, uint256[] memory claimedAmounts)
  {
    require(user != address(0), 'INVALID_USER_ADDRESS');
    require(to != address(0), 'INVALID_TO_ADDRESS');
    (rewardsList, claimedAmounts) = _claimAllRewards(assets, msg.sender, user, to);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020009,0)}
  }
  ...
  function claimAllRewardsToSelf(
    ...
    (rewardsList, claimedAmounts) = _claimAllRewards(assets, msg.sender, msg.sender, msg.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000a,0)}
  }
  ...
  function _getUserAssetBalances(
    ...
    userAssetBalances = new RewardsDataTypes.UserAssetBalance[](assets.length);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000b,0)}
    for (uint256 i; i < assets.length; i++) {
      userAssetBalances[i].asset = assets[i];address certora_local16 = userAssetBalances[i].asset;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,certora_local16)}
      (userAssetBalances[i].userBalance, userAssetBalances[i].totalSupply) = IScaledBalanceToken(
        assets[i]
      ).getScaledUserBalanceAndSupply(user);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020011,0)}
    }
  }
  ...
  function _claimRewards(
    ...
    if (amount != 0) {
      ...
      for (uint256 i; i < assets.length; i++) {
        ...
        totalRewards += _assets[asset].rewards[reward].usersData[user].accrued;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,totalRewards)}

        if (totalRewards <= amount) {
          _assets[asset].rewards[reward].usersData[user].accrued = 0;
        } else {
          uint256 difference = totalRewards - amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000015,difference)}
          totalRewards -= difference;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000016,totalRewards)}
  ...
  function _claimAllRewards(
    ...
    uint256 rewardsListLength = _rewardsList.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,rewardsListLength)}
    rewardsList = new address[](rewardsListLength);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000c,0)}
    claimedAmounts = new uint256[](rewardsListLength);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000d,0)}

    _updateDataMultiple(user, _getUserAssetBalances(assets, user));

    for (uint256 i; i < assets.length; i++) {
      address asset = assets[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,asset)}
  ...
  function _transferRewards(address to, address reward, uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110000, 1037618708497) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111000, to) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111001, reward) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111002, amount) }
    ITransferStrategyBase transferStrategy = _transferStrategy[reward];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010005,0)}

    bool success = transferStrategy.performTransfer(to, reward, amount);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,success)}
  ...
  function _isContract(address account) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00140000, 1037618708500) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00140001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00141000, account) }
    ...
    uint256 size;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,size)}
