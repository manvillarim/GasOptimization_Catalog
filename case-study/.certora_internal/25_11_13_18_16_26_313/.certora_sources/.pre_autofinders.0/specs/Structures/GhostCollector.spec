...
ghost mapping(bytes32 => bytes32) ghost_a_roleAdmin {
    init_state axiom forall bytes32 role. ghost_a_roleAdmin[role] == to_bytes32(0);
}

ghost mapping(bytes32 => bytes32) ghost_ao_roleAdmin {
    init_state axiom forall bytes32 role. ghost_ao_roleAdmin[role] == to_bytes32(0);
}
