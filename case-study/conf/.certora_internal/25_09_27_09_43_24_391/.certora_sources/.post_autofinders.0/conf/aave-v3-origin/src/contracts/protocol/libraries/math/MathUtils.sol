...
library MathUtils {
  ...
  ) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b0000, 1037618708507) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b1000, rate) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b1001, lastUpdateTimestamp) }
  ...
  ) internal pure returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c0000, 1037618708508) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1000, rate) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1001, lastUpdateTimestamp) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1002, currentTimestamp) }
    //solium-disable-next-line
  ...
  function calculateCompoundedInterest(
    uint256 rate,
    uint40 lastUpdateTimestamp
  ) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d0000, 1037618708509) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d1000, rate) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d1001, lastUpdateTimestamp) }
