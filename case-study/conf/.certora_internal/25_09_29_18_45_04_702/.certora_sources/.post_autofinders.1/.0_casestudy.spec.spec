...
methods {
    ...
    function a.getUserAccruedRewards() external returns (uint256, uint256, uint256, uint256, uint256, bool) envfree;
    function ao.getUserAccruedRewards() external returns (uint256, uint256, uint256, uint256, uint256, bool) envfree;
}
