...
contract RewardsDistributorOriginal is RewardsDistributor {
    ...
    function _getUserAssetBalances(
        ...
        address user
    ) internal view override returns (RewardsDataTypes.UserAssetBalance[] memory userAssetBalances) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00180000, 1037618708504) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00180001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00183000, assets.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00182000, assets.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00181001, user) }
