...
methods {
    ...
    function a.getUserRewards(address[], address, address) external returns (uint256) envfree;
    function ao.getUserRewards(address[], address, address) external returns (uint256) envfree;
    ...
    function a.getAssetIndex(address, address) external returns (uint256, uint256) envfree;
    function ao.getAssetIndex(address, address) external returns (uint256, uint256) envfree;
...
definition couplingInv() returns bool =
    // Dados críticos do usuário devem ser iguais
    ...
    // Dados da distribuição devem ser iguais
