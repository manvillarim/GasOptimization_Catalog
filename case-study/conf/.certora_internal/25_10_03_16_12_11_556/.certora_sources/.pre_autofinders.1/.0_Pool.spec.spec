...
methods {
    ...
    function a.getReserveData(address) external returns (DataTypes.ReserveDataLegacy) envfree;
    function ao.getReserveData(address) external returns (DataTypes.ReserveDataLegacy) envfree;
    
    function a.getConfiguration(address) external returns (DataTypes.ReserveConfigurationMap) envfree;
    function ao.getConfiguration(address) external returns (DataTypes.ReserveConfigurationMap) envfree;
    
    function a.getUserConfiguration(address) external returns (DataTypes.UserConfigurationMap) envfree;
    function ao.getUserConfiguration(address) external returns (DataTypes.UserConfigurationMap) envfree;
