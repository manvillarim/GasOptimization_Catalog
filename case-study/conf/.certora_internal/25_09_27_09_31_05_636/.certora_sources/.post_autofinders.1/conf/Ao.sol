...
contract Ao {
    ...
    function getUserAccruedRewards(address user, address reward) public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00220000, 1037618708514) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00220001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00221000, user) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00221001, reward) }
    ...
    function calculateLinearInterest() public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00230000, 1037618708515) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00230001, 0) }
