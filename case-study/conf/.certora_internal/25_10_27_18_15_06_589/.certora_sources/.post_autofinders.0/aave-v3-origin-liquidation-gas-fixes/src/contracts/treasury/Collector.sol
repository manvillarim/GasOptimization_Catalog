...
contract Collector is AccessControlUpgradeable, ReentrancyGuardUpgradeable, ICollector {
  ...
  function createStream(
    ...
    uint256 duration = stopTime - startTime;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000029,duration)}
    ...
    streamId = _nextStreamId++;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003e,streamId)}
  ...
  function withdrawFromStream(
    ...
    uint256 newBalance = stream.remainingBalance - amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002f,newBalance)}
