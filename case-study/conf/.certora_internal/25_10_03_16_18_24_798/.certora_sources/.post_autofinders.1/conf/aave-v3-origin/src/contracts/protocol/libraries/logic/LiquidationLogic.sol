...
library LiquidationLogic {
  ...
  function executeEliminateDeficit(
    ...
    DataTypes.ReserveData storage reserve = reservesData[params.asset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010060,0)}
    uint256 currentDeficit = reserve.deficit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000061,currentDeficit)}

    require(currentDeficit != 0, Errors.RESERVE_NOT_IN_DEFICIT);
    require(!userConfig.isBorrowingAny(), Errors.USER_CANNOT_HAVE_DEBT);

    DataTypes.ReserveCache memory reserveCache = reserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010062,0)}
    reserve.updateState(reserveCache);
    bool isActive = reserveCache.reserveConfiguration.getActive();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000063,isActive)}
    require(isActive, Errors.RESERVE_INACTIVE);

    uint256 balanceWriteOff = params.amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000064,balanceWriteOff)}
    ...
    uint256 userBalance = reserveCache.reserveConfiguration.getIsVirtualAccActive()
      ...
      : IERC20(params.asset).balanceOf(msg.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000065,userBalance)}
    ...
    reserve.deficit -= balanceWriteOff.toUint128();uint128 certora_local112 = reserve.deficit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000070,certora_local112)}
  ...
  function executeLiquidationCall(
    ...
    LiquidationCallLocalVars memory vars;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010066,0)}

    DataTypes.ReserveData storage collateralReserve = reservesData[params.collateralAsset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010067,0)}
    DataTypes.ReserveData storage debtReserve = reservesData[params.debtAsset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010068,0)}
    DataTypes.UserConfigurationMap storage userConfig = usersConfig[params.user];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010069,0)}
    vars.debtReserveCache = debtReserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020071,0)}
    ...
    );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020072,0)}

    vars.collateralAToken = IAToken(collateralReserve.aTokenAddress);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020073,0)}
    vars.userCollateralBalance = vars.collateralAToken.balanceOf(params.user);uint256 certora_local116 = vars.userCollateralBalance;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000074,certora_local116)}
    vars.userReserveDebt = IERC20(vars.debtReserveCache.variableDebtTokenAddress).balanceOf(
      params.user
    );uint256 certora_local117 = vars.userReserveDebt;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000075,certora_local117)}
    ...
    if (
      ...
      vars.liquidationBonus = collateralReserve.configuration.getLiquidationBonus();uint256 certora_local134 = vars.liquidationBonus;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000086,certora_local134)}
    }
    vars.collateralAssetPrice = IPriceOracleGetter(params.priceOracle).getAssetPrice(
      params.collateralAsset
    );uint256 certora_local118 = vars.collateralAssetPrice;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000076,certora_local118)}
    vars.debtAssetPrice = IPriceOracleGetter(params.priceOracle).getAssetPrice(params.debtAsset);uint256 certora_local119 = vars.debtAssetPrice;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000077,certora_local119)}
    vars.collateralAssetUnit = 10 ** collateralReserve.configuration.getDecimals();uint256 certora_local120 = vars.collateralAssetUnit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000078,certora_local120)}
    vars.debtAssetUnit = 10 ** vars.debtReserveCache.reserveConfiguration.getDecimals();uint256 certora_local121 = vars.debtAssetUnit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000079,certora_local121)}

    vars.userReserveDebtInBaseCurrency =
      (vars.userReserveDebt * vars.debtAssetPrice) /
      vars.debtAssetUnit;uint256 certora_local122 = vars.userReserveDebtInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007a,certora_local122)}

    vars.userReserveCollateralInBaseCurrency =
      (vars.userCollateralBalance * vars.collateralAssetPrice) /
      vars.collateralAssetUnit;uint256 certora_local123 = vars.userReserveCollateralInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007b,certora_local123)}

    // by default whole debt in the reserve could be liquidated
    uint256 maxLiquidatableDebt = vars.userReserveDebt;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006a,maxLiquidatableDebt)}
    ...
    vars.actualDebtToLiquidate = params.debtToCover > maxLiquidatableDebt
      ? maxLiquidatableDebt
      : params.debtToCover;uint256 certora_local124 = vars.actualDebtToLiquidate;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007c,certora_local124)}
    ...
    );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002007d,0)}
    ...
    bool hasNoCollateralLeft = vars.totalCollateralInBaseCurrency ==
      vars.collateralToLiquidateInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006b,hasNoCollateralLeft)}
    _burnDebtTokens(
  ...
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d0000, 1037618708749) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d1000, collateralReserve.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d1001, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010d1002, vars) }
    DataTypes.ReserveCache memory collateralReserveCache = collateralReserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006c,0)}
  ...
  function _liquidateATokens(
    ...
    DataTypes.ExecuteLiquidationCallParams memory params,
    LiquidationCallLocalVars memory vars
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e0000, 1037618708750) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e0001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e1000, reservesData.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e1001, reservesList.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e1002, usersConfig.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e1003, collateralReserve.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e1004, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010e1005, vars) }
    uint256 liquidatorPreviousATokenBalance = IERC20(vars.collateralAToken).balanceOf(msg.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006d,liquidatorPreviousATokenBalance)}
    vars.collateralAToken.transferOnLiquidation(
      params.user,
      msg.sender,
      vars.actualCollateralToLiquidate
  ...
  function _burnDebtTokens(
  ...
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01100000, 1037618708752) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01100001, 8) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101000, debtReserveCache) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101001, debtReserve.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101002, userConfig.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101003, user) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101004, debtAsset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101005, userReserveDebt) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101006, actualDebtToLiquidate) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01101007, hasNoCollateralLeft) }
    ...
    uint256 outstandingDebt = userReserveDebt - actualDebtToLiquidate;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006e,outstandingDebt)}
  ...
  function _calculateAvailableCollateralToLiquidate(
    ...
    uint256 userCollateralBalance,
    uint256 liquidationBonus
  ) internal pure returns (uint256, uint256, uint256, uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110000, 1037618708753) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110001, 8) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111000, collateralReserveConfiguration) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111001, collateralAssetPrice) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111002, collateralAssetUnit) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111003, debtAssetPrice) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111004, debtAssetUnit) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111005, debtToCover) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111006, userCollateralBalance) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01111007, liquidationBonus) }
    AvailableCollateralToLiquidateLocalVars memory vars;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006f,0)}
    vars.collateralAssetPrice = collateralAssetPrice;uint256 certora_local126 = vars.collateralAssetPrice;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007e,certora_local126)}
    vars.liquidationProtocolFeePercentage = collateralReserveConfiguration
      .getLiquidationProtocolFee();uint256 certora_local127 = vars.liquidationProtocolFeePercentage;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007f,certora_local127)}

    // This is the base collateral to liquidate based on the given debt to cover
    vars.baseCollateral =
      ((debtAssetPrice * debtToCover * collateralAssetUnit)) /
      (vars.collateralAssetPrice * debtAssetUnit);uint256 certora_local128 = vars.baseCollateral;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000080,certora_local128)}

    vars.maxCollateralToLiquidate = vars.baseCollateral.percentMul(liquidationBonus);uint256 certora_local129 = vars.maxCollateralToLiquidate;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000081,certora_local129)}
    ...
    if (vars.maxCollateralToLiquidate > userCollateralBalance) {
      ...
      vars.collateralAmount = vars.maxCollateralToLiquidate;uint256 certora_local135 = vars.collateralAmount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000087,certora_local135)}
      vars.debtAmountNeeded = debtToCover;uint256 certora_local136 = vars.debtAmountNeeded;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000088,certora_local136)}
    }

    vars.collateralToLiquidateInBaseCurrency =
      (vars.collateralAmount * vars.collateralAssetPrice) /
      collateralAssetUnit;uint256 certora_local130 = vars.collateralToLiquidateInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000082,certora_local130)}
  ...
  function _burnBadDebt(
    ...
    address user
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f0000, 1037618708751) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f1000, reservesData.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f1001, reservesList.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f1002, userConfig.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f1003, reservesCount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010f1004, user) }
    for (uint256 i; i < reservesCount; i++) {
      if (!userConfig.isBorrowing(i)) {
        continue;
      }

      address reserveAddress = reservesList[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000083,reserveAddress)}
      if (reserveAddress == address(0)) {
        continue;
      }

      DataTypes.ReserveData storage currentReserve = reservesData[reserveAddress];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010084,0)}
      DataTypes.ReserveCache memory reserveCache = currentReserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010085,0)}
