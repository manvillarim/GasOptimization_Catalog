...
library LiquidationLogic {
  ...
  function executeEliminateDeficit(
    ...
    DataTypes.ReserveData storage reserve = reservesData[params.asset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010064,0)}
    uint256 currentDeficit = reserve.deficit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000065,currentDeficit)}

    require(currentDeficit != 0, Errors.RESERVE_NOT_IN_DEFICIT);
    require(!userConfig.isBorrowingAny(), Errors.USER_CANNOT_HAVE_DEBT);

    DataTypes.ReserveCache memory reserveCache = reserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010066,0)}
    reserve.updateState(reserveCache);
    bool isActive = reserveCache.reserveConfiguration.getActive();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000067,isActive)}
    require(isActive, Errors.RESERVE_INACTIVE);

    uint256 balanceWriteOff = params.amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000068,balanceWriteOff)}
    ...
    uint256 userBalance = reserveCache.reserveConfiguration.getIsVirtualAccActive()
      ...
      : IERC20(params.asset).balanceOf(msg.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000069,userBalance)}
    ...
    reserve.deficit -= balanceWriteOff.toUint128();uint128 certora_local122 = reserve.deficit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007a,certora_local122)}
  ...
  function executeLiquidationCall(
    ...
    LiquidationCallLocalVars memory vars;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006a,0)}

    DataTypes.ReserveData storage collateralReserve = reservesData[params.collateralAsset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006b,0)}
    DataTypes.ReserveData storage debtReserve = reservesData[params.debtAsset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006c,0)}
    vars.debtReserveCache = debtReserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002007b,0)}
    ...
    vars.userConfigCache = usersConfig[params.user];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002007c,0)}
    ...
    (vars.collateralReserveId, vars.collateralAToken) = (collateralReserve.id, IAToken(collateralReserve.aTokenAddress));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002007e,0)}
    vars.userCollateralBalance = vars.collateralAToken.balanceOf(params.user);uint256 certora_local127 = vars.userCollateralBalance;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007f,certora_local127)}
    uint256 userReserveDebt = IERC20(vars.debtReserveCache.variableDebtTokenAddress).balanceOf(
      params.user
    );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006d,userReserveDebt)}
    vars.collateralReserveConfigCache = collateralReserve.configuration;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020080,0)}
    ...
    uint256 liquidationBonus;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006e,liquidationBonus)}
    if (
      ...
      liquidationBonus = vars.collateralReserveConfigCache.getLiquidationBonus();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008d,liquidationBonus)}
    }
    uint256 collateralAssetPrice = IPriceOracleGetter(params.priceOracle).getAssetPrice(
      params.collateralAsset
    );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006f,collateralAssetPrice)}
    vars.debtAssetPrice = IPriceOracleGetter(params.priceOracle).getAssetPrice(params.debtAsset);uint256 certora_local129 = vars.debtAssetPrice;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000081,certora_local129)}
    vars.collateralAssetUnit = 10 ** vars.collateralReserveConfigCache.getDecimals();uint256 certora_local130 = vars.collateralAssetUnit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000082,certora_local130)}
    vars.debtAssetUnit = 10 ** vars.debtReserveCache.reserveConfiguration.getDecimals();uint256 certora_local131 = vars.debtAssetUnit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000083,certora_local131)}

    vars.userReserveDebtInBaseCurrency =
      (userReserveDebt * vars.debtAssetPrice) /
      vars.debtAssetUnit;uint256 certora_local132 = vars.userReserveDebtInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000084,certora_local132)}

    vars.userReserveCollateralInBaseCurrency =
      (vars.userCollateralBalance * collateralAssetPrice) /
      vars.collateralAssetUnit;uint256 certora_local133 = vars.userReserveCollateralInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000085,certora_local133)}

    // by default whole debt in the reserve could be liquidated
    uint256 maxLiquidatableDebt = userReserveDebt;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000070,maxLiquidatableDebt)}
    ...
    vars.actualDebtToLiquidate = params.debtToCover > maxLiquidatableDebt
      ? maxLiquidatableDebt
      : params.debtToCover;uint256 certora_local134 = vars.actualDebtToLiquidate;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000086,certora_local134)}
    ...
    (
      ...
      liquidationBonus
    );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020087,0)}
    ...
    bool hasNoCollateralLeft = vars.totalCollateralInBaseCurrency ==
      vars.collateralToLiquidateInBaseCurrency;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000071,hasNoCollateralLeft)}
    _burnDebtTokens(
    ...
    usersConfig[params.user] = vars.userConfigCache;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020088,0)}
  }
  ...
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e0000, 1037618708590) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e1000, collateralReserve.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e1001, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006e1002, vars) }
    DataTypes.ReserveCache memory collateralReserveCache = collateralReserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010072,0)}
  ...
  function _liquidateATokens(
    ...
    DataTypes.ExecuteLiquidationCallParams memory params,
    LiquidationCallLocalVars memory vars
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f0000, 1037618708591) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f1000, reservesData.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f1001, reservesList.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f1002, liquidatorConfig.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f1003, params) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff006f1004, vars) }
    uint256 liquidatorPreviousATokenBalance = IERC20(vars.collateralAToken).balanceOf(msg.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000073,liquidatorPreviousATokenBalance)}
    vars.collateralAToken.transferOnLiquidation(
      params.user,
      msg.sender,
      vars.actualCollateralToLiquidate
    ...
    bool isSelfLiquidation = msg.sender == params.user;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000074,isSelfLiquidation)}
  ...
  function _burnDebtTokens(
  ...
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00710000, 1037618708593) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00710001, 8) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711000, debtReserveCache) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711001, debtReserve.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711002, userConfig) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711003, user) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711004, debtAsset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711005, userReserveDebt) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711006, actualDebtToLiquidate) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00711007, hasNoCollateralLeft) }
    ...
    uint256 outstandingDebt = userReserveDebt - actualDebtToLiquidate;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000075,outstandingDebt)}
  ...
  function _calculateAvailableCollateralToLiquidate(
  ...
  ) internal pure returns (uint256 collateralAmount, uint256 debtAmountNeeded, uint256 liquidationProtocolFee, uint256 collateralToLiquidateInBaseCurrency) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00720000, 1037618708594) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00720001, 8) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721000, collateralReserveConfiguration) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721001, collateralAssetPrice) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721002, collateralAssetUnit) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721003, debtAssetPrice) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721004, debtAssetUnit) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721005, debtToCover) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721006, userCollateralBalance) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00721007, liquidationBonus) }
    uint256 collateralAssetPrice = collateralAssetPrice;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000076,collateralAssetPrice)}
    uint256 liquidationProtocolFeePercentage = collateralReserveConfiguration
      .getLiquidationProtocolFee();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000077,liquidationProtocolFeePercentage)}

    // This is the base collateral to liquidate based on the given debt to cover
    uint256 baseCollateral =
      ((debtAssetPrice * debtToCover * collateralAssetUnit)) /
      (collateralAssetPrice * debtAssetUnit);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000078,baseCollateral)}

    uint256 maxCollateralToLiquidate = baseCollateral.percentMul(liquidationBonus);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000079,maxCollateralToLiquidate)}
    ...
    if (maxCollateralToLiquidate > userCollateralBalance) {
      ...
      collateralAmount = maxCollateralToLiquidate;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008e,collateralAmount)}
      debtAmountNeeded = debtToCover;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008f,debtAmountNeeded)}
    }

    collateralToLiquidateInBaseCurrency =
      (collateralAmount * collateralAssetPrice) /
      collateralAssetUnit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000089,collateralToLiquidateInBaseCurrency)}
  ...
  function _burnBadDebt(
    ...
    address user
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00700000, 1037618708592) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00700001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00701000, reservesData.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00701001, reservesList.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00701002, userConfig) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00701003, reservesCount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00701004, user) }
    for (uint256 i; i < reservesCount; i++) {
      if (!userConfig.isBorrowing(i)) {
        continue;
      }

      address reserveAddress = reservesList[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008a,reserveAddress)}
      if (reserveAddress == address(0)) {
        continue;
      }

      DataTypes.ReserveData storage currentReserve = reservesData[reserveAddress];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001008b,0)}
      DataTypes.ReserveCache memory reserveCache = currentReserve.cache();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001008c,0)}
