...
methods {
    ...
    // Summary para IERC20.balanceOf
    function _.balanceOf(address) external => ghostTokenBalance[calledContract][to_mathint(args[0])];
...
definition couplingInv() returns bool =
    ...
    (forall uint256 i. i < 53 =>  a.______gap[i] ==  ao.______gap[i]) &&
