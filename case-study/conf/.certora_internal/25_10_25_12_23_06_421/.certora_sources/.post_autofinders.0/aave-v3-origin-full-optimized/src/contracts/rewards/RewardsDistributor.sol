...
abstract contract RewardsDistributor is IRewardsDistributor {
  ...
  function setEmissionPerSecond(
    ...
    for (uint256 i; i < rewardsLength; ++i) {
      ...
      uint256 oldEmissionPerSecond = 2 * rewardConfig.emissionPerSecond;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000028,oldEmissionPerSecond)}
