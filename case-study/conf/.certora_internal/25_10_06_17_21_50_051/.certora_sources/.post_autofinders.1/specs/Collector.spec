...
methods {
    ...
    function a.deltaOf(uint256) external returns (uint256);
    function ao.deltaOf(uint256) external returns (uint256);
    
    function a.balanceOf(uint256, address) external returns (uint256);
    function ao.balanceOf(uint256, address) external returns (uint256);
}
