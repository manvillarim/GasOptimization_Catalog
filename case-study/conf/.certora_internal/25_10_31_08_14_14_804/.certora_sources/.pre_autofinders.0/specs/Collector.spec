...
methods {
    ...
    function _.safeTransfer(address, uint256) external => DISPATCHER(true) ALL;
    
    function _.forceApprove(address, uint256) external => DISPATCHER(true) ALL;
    
    function _.call(bytes) external with (env e) => optimisticFallback(e) expect (bool, bytes) ALL;
