...
contract PoolAddressesProviderRegistry is Ownable, IPoolAddressesProviderRegistry {
  ...
  function unregisterAddressesProvider(address provider) external override onlyOwner {
    ...
    uint256 oldId = _addressesProviderToId[provider];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,oldId)}
   ...
   * @param provider The address of the PoolAddressesProvider
   */
  function _removeFromAddressesProvidersList(address provider) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130000, 1037618708499) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00131000, provider) }
    uint256 index = _addressesProvidersIndexes[provider];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,index)}
    ...
    uint256 lastIndex = _addressesProvidersList.length - 1;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,lastIndex)}
    if (index < lastIndex) {
