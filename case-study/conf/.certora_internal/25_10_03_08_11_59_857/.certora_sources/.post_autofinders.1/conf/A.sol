...
import{RewardsDistributorHarness} from "./harness/RewardsDistributor/RewardsDistributorHarness.sol";
contract A {
    
     // Este É o RewardsDistributor que o Certora vai instrumentar
    RewardsDistributorHarness public rewardsDistributor;
    
    constructor(address emissionManager) {
        rewardsDistributor = new RewardsDistributorHarness(emissionManager);
    }
    
    // Métodos wrapper (mesma interface do A original)
    ...
    {
        return rewardsDistributor.getRewardsData(asset, reward);
    }
}