...
definition couplingInv() returns bool = a.isPaused() == ao.isPaused() && a.totalSupply() == ao.TOTAL_SUPPLY() && a.owner() == ao.OWNER() && a.mintingFee() == ao.MINTING_FEE() && a.maxTransactionAmount() == ao.MAX_TRANSACTION_AMOUNT();
