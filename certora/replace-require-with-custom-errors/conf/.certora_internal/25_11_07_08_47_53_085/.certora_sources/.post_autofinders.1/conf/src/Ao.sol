...
contract Ao {
    ...
    function unstake() external whenNotPaused {
        ...
        uint256 elapsed = block.timestamp - stakingTimestamps[msg.sender];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,elapsed)}
        ...
        uint256 amount = stakedBalances[msg.sender];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,amount)}
