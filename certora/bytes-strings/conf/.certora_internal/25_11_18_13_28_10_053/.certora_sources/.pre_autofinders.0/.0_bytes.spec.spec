...
definition stringToBytes32(string s) returns bytes32 = to_bytes32(s);

definition couplingInv() returns bool =
    a.names.length == ao.names.length &&
    (forall address user. stringToBytes32(a.userNames[user]) == ao.userNames[user]) &&
    (forall uint256 i. (i < a.names.length => stringToBytes32(a.names[i]) == ao.names[i]));
