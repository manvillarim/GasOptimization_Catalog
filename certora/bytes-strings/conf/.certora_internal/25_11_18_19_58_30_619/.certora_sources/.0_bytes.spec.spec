...
// --- FUNÇÕES DE HASH AUXILIARES (Removida a keyword 'memory') ---
// Linha 5
...
methods {
    ...
    // Linha 25
    function a.getUserName(address) external view envfree ;
    // Linha 26
    function ao.getUserName(address) external view envfree ;
    // Linha 27
    function a.getNameAt(uint256) external view envfree;
    // Linha 28
    function ao.getNameAt(uint256) external view envfree;
    // Linha 29
    function a.compareNames(string, string) external pure envfree;
    // Linha 30
    function ao.compareNames(bytes, bytes) external pure envfree;
}
