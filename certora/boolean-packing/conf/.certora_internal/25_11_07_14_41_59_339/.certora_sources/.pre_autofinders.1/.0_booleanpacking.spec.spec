...
definition couplingInv() returns bool = a.canMint() == ao.canMint() && 
a.isPaused() == ao.isPaused() && 
a.isAdmin() == ao.isAdmin() && 
a.isWhitelisted() == ao.isWhitelisted() && 
a.transferEnabled() == ao.transferEnabled() &&
 a.isFrozen() == ao.isFrozen();
