...
contract Ao {
    ...
    function addValue(uint256 _value) external returns (uint256 index) {
        ...
        index = state.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,index)}
    ...
    function getValue(uint256 _index) external view returns (uint256) {
        ...
        uint256 value = values[_index];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,value)}
    ...
    function updateValue(uint256 _index, uint256 _newValue) external {
        ...
        uint256 oldValue = values[_index];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000002,oldValue)}
    ...
    function removeValue(uint256 _index) external {
        ...
        uint256 removedValue = values[_index];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,removedValue)}
    ...
    function getRangeSum(uint256 _start, uint256 _end) external view returns (uint256 sum) {
        ...
        for (uint256 i = _start; i <= _end; i++) {
            uint256 value = values[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,value)}
