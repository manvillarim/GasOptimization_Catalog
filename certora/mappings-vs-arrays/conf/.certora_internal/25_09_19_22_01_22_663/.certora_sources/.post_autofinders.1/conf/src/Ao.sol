...
contract Ao {
    ...
    function addValue(uint256 _value) external returns (uint256 index) {
        index = nextIndex;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,index)}
    ...
    function batchAdd(uint256[] calldata _values) external {
        uint256 startIndex = nextIndex;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,startIndex)}
