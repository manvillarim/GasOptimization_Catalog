...
filtered { f -> !f.isView && f.contract == ini,
            g -> !g.isView && g.contract == fnl }{

    require g.selector == f.selector && f.numberOfArguments == g.numberOfArguments && !f.isPure &&  !g.isPure && !f.isFallback && !g.isFallback;
    env eOrig;
    env eNew;
    calldataarg args;
