...
methods {
    function a.getAuthorized() external returns (bool) envfree;
    function ao.getAuthorized() external returns (bool) envfree;
}
...
definition couplingInv() returns bool =
    a.owner == ao.owner &&
    a.paused == ao.paused &&
    (forall address addr. (a.getAuthorized(addr) == ao.getAuthorized(addr))) && // Verifica o mapeamento 'authorized'
    a.total == ao.total &&
    a.count == ao.count &&
