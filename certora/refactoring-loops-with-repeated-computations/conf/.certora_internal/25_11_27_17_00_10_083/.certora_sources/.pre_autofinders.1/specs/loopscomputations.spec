...
a.limit == ao.limit && 
a.price == ao.price && 
a.baseReward == ao.baseReward && 
a.multiplier == ao.multiplier && 
a.taxRate == ao.taxRate && 
...
a.penalties.length == ao.penalties.length && 
(forall uint256 i. (i < a.penalties.length => a.penalties[i] == ao.penalties[i]));
