...
contract A {
    ...
    uint public deploymentBlock;    // Storage slot 3
    uint public maxSupply;          // Storage slot 4
    uint8 public decimals;          // Storage slot 5
    bytes32 public merkleRoot;      // Storage slot 6
     ...
     * @dev Performs 5 storage reads - each costs 2100 gas
     */
